...
public class HttpTookit {
	 ...
	 *
	 * @param url      发送请求的 URL
	 * @param paramSet 请求参数，请求参数应该是 name1=value1&name2=value2 的形式。
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPostArrayFirst(String url, Map<String, String[]> paramSet) throws Exception {
		PrintWriter out = null;
		BufferedReader in = null;
		String result = "";
		String param = "";
		if (paramSet != null) {
			for (Entry<String, String[]> set : paramSet.entrySet()) {
				param += set.getKey() + "=" + set.getValue()[0] + "&";
			}
		}
		URL realUrl = new URL(url);
		// 打开和URL之间的连接
