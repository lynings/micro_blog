    ...
    <div class="top-bar-container index-top-bg img">
      <div class="content">
        <div class="button-list">
          <div class="logo">
            <a href="#" >
              <img class="logo-tuniu" src="${pageContext.request.contextPath}/images/index-logo.png"/>
            </a>
          </div>
...
<div id="loginBox" class="customBox modal fade myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
  ...
  <div class="login-form">
    <div class="login">
      <a href="#" >
        <img class="logo-tuniu" src="${pageContext.request.contextPath}/images/iconfont-tuniu.png" style="width: 30px; height: 30px;"/>
      </a>
    </div>
  ...
  <div class="modal-header">
    <h4 class="modal-title" style="border-bottom: 0;border-top: 1px solid #e1e8ed;font-size: 14px;">还没有账号吗? <a href="#" id="fromRegister">注册</a> </h4>
  </div>
</div>
...
<div id="registerBox" class="customBox modal fade myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
  ...
  <div class="login-form">
    ...
    <form action="${pageContext.request.contextPath}/ctrl/user/register" method="post">
      <div class="input-group">
        <input type="text" name="name" class="form-control" placeholder="全名" aria-describedby="basic-addon1" autofocus required/>
      </div>
      <div class="input-group">
...
<script type="text/javascript">
  $(document).ready(function () {
    function home() {
      ...
      $('#fromRegister').click(function (e) {
        showRegisterBox(e)
      });

      function showRegisterBox(e) {
        $('.close').click();
