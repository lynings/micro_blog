    ...
    app.config(function ($routeProvider) {
        $routeProvider
            ...
            .when("/", angularAMD.route({
                templateUrl: 'views/basic/user/home.html',
                controller: 'HomeOperationCtrl',
                controllerUrl: 'controller/home/homeOperation'
            }))
            .when("/basic/user", angularAMD.route({
                templateUrl: 'views/basic/user/userInfo.html',
                controller: 'UserOperationCtrl',
                controllerUrl: 'controller/basic/user/userOperation'
            }))
            .when("/user/follow", angularAMD.route({
                templateUrl: 'views/user/follow.html',
                controller: 'FollowCtrl',
                controllerUrl: 'controller/user/follow'
            }))
            .when("/user/twitter", angularAMD.route({
                templateUrl: 'views/user/twitter.html',
                controller: 'FollowCtrl',
                controllerUrl: 'controller/user/twitter'
            }))
    });
